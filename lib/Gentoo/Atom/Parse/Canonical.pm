use strict;
use warnings;
package Gentoo::Atom::Parse::Canonical;
# FILENAME: Canonical.pm
# CREATED: 22/10/11 17:54:38 by Kent Fredric (kentnl) <kentfredric@gmail.com>
# ABSTRACT: Parse Canonicalised Gentoo Atoms
